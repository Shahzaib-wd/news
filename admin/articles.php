...
if (isset($_GET['delete']) && isset($_GET['csrf_token'])) {
    if (verifyCSRFToken($_GET['csrf_token'])) {
        ...
        if ($article) {
            ...
            // Delete article (cascades to likes, comments, article_tag)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="<?= getArticleURL($article['slug']) ?>" target="_blank" 
                                   class="btn btn-sm btn-outline-secondary" title="View">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?= BASE_URL ?>/admin/article-edit.php?id=<?= $article['id'] ?>" 
                                   class="btn btn-sm btn-outline-primary" title="Edit">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <a href="?delete=<?= $article['id'] ?>&csrf_token=<?= generateCSRFToken() ?>" 
                                   class="btn btn-sm btn-outline-danger" 
                                   onclick="return confirmDelete('Delete this article?')" title="Delete">
